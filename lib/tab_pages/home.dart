...
import 'package:drivers_app/assistants/assistants_methods.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  locateDriverCurrentPosition() async {
    ...
    String humanReadableAddress = await AssistantMethods.getLocationFromApiInHumanReadableForm(driverCurrentPosition!, context);
