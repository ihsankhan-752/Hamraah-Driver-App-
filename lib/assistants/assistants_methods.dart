...
//=====================To SEE USER LOCATION IN READABLE FORM========================//
  static Future<String> getLocationFromApiInHumanReadableForm(Position position, BuildContext context) async {
    String apiUrl = "https://maps.googleapis.com/maps/api/geocode/json?latlng=${position.latitude},${position.longitude}&key=$mapApiKey";
  ...
  static Future<DirectionDetailInfo?> obtainOriginToDestinationDirectionsDetails(LatLng originPosition, LatLng destinationPosition) async {
    String url =
