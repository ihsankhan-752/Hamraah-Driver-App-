...
import 'package:drivers_app/models/user_ride_request_information_model.dart';
import 'package:drivers_app/widgets/map_black_theme.dart';
...
class _NewTripScreenState extends State<NewTripScreen> {
  ...
  Future<void> drawPolyLineFromOriginToDestination(LatLng originLatLng, LatLng destinationLatLng) async {
    ...
    var directionDetailsInfo = await AssistantMethods.obtainOriginToDestinationDirectionsDetails(originLatLng, destinationLatLng);
  ...
  updateDurationTimeAtRealTime() async {
    if (isRequestDirectionDetails == false) {
      ...
      var directionInformation = await AssistantMethods.obtainOriginToDestinationDirectionsDetails(originLatLng, destinationLatLng);
  ...
  saveFareAmountToDriverEarnings(double totalFareAmount) {
    FirebaseDatabase.instance.ref().child("drivers").child(currentFirebaseUser!.uid).child("earnings").once().then((snap) {
      if (snap.snapshot.value != null) {
        ...
        FirebaseDatabase.instance.ref().child("drivers").child(currentFirebaseUser!.uid).child("earnings").set(driverTotalEarning);
      } else {
